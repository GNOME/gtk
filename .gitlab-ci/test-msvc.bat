...
meson setup _build -Dbackend_max_links=1 -Ddebug=false -Dwin32-backend=true -Dmedia-gstreamer=disabled -Dvulkan=disabled -Daccesskit=enabled -Daccesskit-c:triplet=%RUST_HOST% %~1 || goto :error
