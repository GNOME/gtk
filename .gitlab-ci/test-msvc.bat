...
meson setup -Dbackend_max_links=1 -Ddebug=false -Dwin32-backend=true -Dmedia-gstreamer=disabled -Dlibrsvg=disabled -Dvulkan=disabled -Daccesskit=enabled _build %~1 || goto :error
