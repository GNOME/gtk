...
{
  const char *names[] = {
    "actions/bookmark-new-symbolic",
    "actions/color-select-symbolic",
    "actions/document-open-recent-symbolic",
    "actions/document-open-symbolic",
    "actions/document-save-as-symbolic",
    "actions/document-save-symbolic",
    "actions/edit-clear-all-symbolic",
    "actions/edit-clear-symbolic-rtl",
    "actions/edit-clear-symbolic",
    "actions/edit-copy-symbolic",
    "actions/edit-cut-symbolic",
    "actions/edit-delete-symbolic",
    "actions/edit-find-symbolic",
    "actions/edit-paste-symbolic",
    "actions/edit-select-all-symbolic",
    "actions/find-location-symbolic",
    "actions/folder-new-symbolic",
    "actions/function-linear-symbolic",
    "actions/go-down-symbolic",
    "actions/go-next-symbolic-rtl",
    "actions/go-next-symbolic",
    "actions/go-previous-symbolic-rtl",
    "actions/go-previous-symbolic",
    "actions/go-up-symbolic",
    "actions/info-outline-symbolic",
    "actions/insert-image-symbolic",
    "actions/insert-object-symbolic",
    "actions/list-add-symbolic",
    "actions/list-remove-all-symbolic",
    "actions/list-remove-symbolic",
    "actions/media-eject-symbolic",
    "actions/media-playback-pause-symbolic",
    "actions/media-playback-start-symbolic",
    "actions/media-playback-stop-symbolic",
    "actions/media-record-symbolic",
    "actions/object-select-symbolic",
    "actions/open-menu-symbolic",
    "actions/pan-down-symbolic",
    "actions/pan-end-symbolic-rtl",
    "actions/pan-end-symbolic",
    "actions/pan-start-symbolic-rtl",
    "actions/pan-start-symbolic",
    "actions/pan-up-symbolic",
    "actions/system-run-symbolic",
    "actions/system-search-symbolic",
    "actions/value-decrease-symbolic",
    "actions/value-increase-symbolic",
    "actions/view-conceal-symbolic",
    "actions/view-grid-symbolic",
    "actions/view-list-symbolic",
    "actions/view-more-symbolic",
    "actions/view-refresh-symbolic",
    "actions/view-reveal-symbolic",
    "actions/window-close-symbolic",
    "actions/window-maximize-symbolic",
    "actions/window-minimize-symbolic",
    "actions/window-restore-symbolic",
    "actions/zoom-in-symbolic",
    "actions/zoom-original-symbolic",
    "actions/zoom-out-symbolic",
    "categories/emoji-activities-symbolic",
    "categories/emoji-body-symbolic",
    "categories/emoji-flags-symbolic",
    "categories/emoji-food-symbolic",
    "categories/emoji-nature-symbolic",
    "categories/emoji-objects-symbolic",
    "categories/emoji-people-symbolic",
    "categories/emoji-recent-symbolic",
    "categories/emoji-symbols-symbolic",
    "categories/emoji-travel-symbolic",
    "status/audio-volume-high-symbolic",
    "status/audio-volume-low-symbolic",
    "status/audio-volume-medium-symbolic",
    "status/audio-volume-muted-symbolic",
    "status/caps-lock-symbolic",
    "status/changes-allow-symbolic",
    "status/changes-prevent-symbolic",
    "status/dialog-error-symbolic",
    "status/dialog-information-symbolic",
    "status/dialog-password-symbolic",
    "status/dialog-question-symbolic",
    "status/dialog-warning-symbolic",
    "status/display-brightness-symbolic",
    "status/media-playlist-repeat-symbolic",
    "status/orientation-landscape-inverse-symbolic",
    "status/orientation-landscape-symbolic",
    "status/orientation-portrait-inverse-symbolic",
    "status/orientation-portrait-symbolic",
    "status/process-working-symbolic",
    "status/switch-off-symbolic",
    "status/switch-on-symbolic",
  };
  ...
  for (guint i = 0; i < 24; i++)
    {
      ...
      path = g_strconcat ("/org/gtk/libgtk/icons/scalable/", names[r], ".svg", NULL);
