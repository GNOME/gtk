                      ...
                      GskPath    *path2)
{
  ...
  switch (self->operation)
    ...
    case 2:
      ...
      gsk_path_builder_add_path (builder, path);
      gsk_path_unref (path);
      path = gsk_path_simplify (self->orig_path2);
      gsk_path_builder_add_path (builder, path);
      gsk_path_unref (path);
      self->path = gsk_path_builder_free_to_path (builder);
      break;
    case 3:
      self->path = gsk_path_union (self->orig_path1, self->orig_path2);
      break;
    case 4:
      self->path = gsk_path_intersection (self->orig_path1, self->orig_path2);
      break;
    case 5:
      self->path = gsk_path_difference (self->orig_path1, self->orig_path2);
      break;
    case 6:
      self->path = gsk_path_symmetric_difference (self->orig_path1, self->orig_path2);
      break;
    default:
      g_assert_not_reached ();
    }
