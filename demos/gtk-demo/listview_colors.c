 ...
 *
 * The dataset used here has BIGNUM items.
 */
...
{
  GtkWidget *box, *picture, *name_label, *rgb_label;
  ...
  gtk_expression_bind (expression, name_label, name_label, "label");
  ...
  gtk_expression_bind (expression, rgb_label, rgb_label, "label");
