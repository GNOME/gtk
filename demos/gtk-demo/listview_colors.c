                   ...
                   GtkListItem        *list_item)
{
  ...
  gtk_expression_bind (expression, name_label, NULL, "label");
  gtk_container_add (GTK_CONTAINER (box), name_label);

  expression = gtk_expression_ref (color_expression);
  picture = gtk_picture_new ();
  gtk_expression_bind (expression, picture, NULL, "paintable");
  ...
  gtk_expression_bind (expression, rgb_label, NULL, "label");
  ...
  gtk_expression_bind (expression, hsv_label, NULL, "label");
