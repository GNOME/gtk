           ...
           const gchar *filename)
{
  ...
  gtk_text_buffer_begin_irreversable_action (info_buffer);
  gtk_text_buffer_begin_irreversable_action (source_buffer);
  ...
  gtk_text_buffer_end_irreversable_action (source_buffer);
  gtk_text_view_set_buffer (GTK_TEXT_VIEW (source_view), source_buffer);
  g_object_unref (source_buffer);

  gtk_text_buffer_end_irreversable_action (info_buffer);
