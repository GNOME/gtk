  ...
  if (!window)
    {
      ...
      gtk_container_add (GTK_CONTAINER (gtk_info_bar_get_content_area (GTK_INFO_BAR (bar))), GTK_WIDGET (label));
      ...
      gtk_container_add (GTK_CONTAINER (actions), GTK_WIDGET (button));
