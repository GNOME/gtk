...
GtkWidget *
gtk_drop_down_new_from_strings (const char *const *titles,
                                const char *const *icons,
                                const char *const *descriptions)
{
  GtkWidget *widget;
...
main (int argc, char *argv[])
{
  ...
  button = gtk_drop_down_new_from_strings (times, NULL, NULL);
  gtk_container_add (GTK_CONTAINER (box), button);

  button = gtk_drop_down_new_from_strings (many_times, NULL, NULL);
  gtk_container_add (GTK_CONTAINER (box), button);
  ...
  button = gtk_drop_down_new_from_strings (device_titles, device_icons, device_descriptions);
  gtk_container_add (GTK_CONTAINER (box), button);
