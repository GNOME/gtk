                    ...
                    gpointer user_data)
{
  ...
  return create_model (base + 1, size - 1, 1);
}
                ...
                GtkListItem              *item)
{
  ...
  obj = gtk_tree_expander_get_item (GTK_TREE_EXPANDER (expander));
  entry = gtk_tree_expander_get_child (GTK_TREE_EXPANDER (expander));
