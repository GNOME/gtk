  ...
  for (i = 0; i < 100; i++)
    {
      ...
      gsk_path_measure_get_point (measure, seg_length, &point2);
  ...
  for (i = 0; i < 100; i++)
    {
      ...
      gsk_path_measure_get_point (measure, length - seg_length, &point1);
      gsk_path_measure_get_point (measure, length, &point2);
  ...
  for (i = 0; i <= 100; i++)
    {
      ...
      gsk_path_measure_get_point (measure, seg_start + length / 2, &point2);
      ...
      gsk_path_measure_get_point (measure, seg_start, &point2);
