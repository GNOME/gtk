...
```
  ...
  1. if the condition is composed of many lines:
...
```
  ...
  1. Nested if's, in which case the block should be placed on the
     outermost if:
...
```
  ...
  1.  If either side of an if-else statement has braces, both sides
