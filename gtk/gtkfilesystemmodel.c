			    ...
			    GError           **error)
{
  ...
  gtk_file_system_get_folder (file_system, root_path, types,
			      got_root_folder_cb, model);
	     ...
	     gpointer             data)
{
  ...
  if (info->node)
    ...
    {
      /* clean up and stop */
      unref_node_and_parents (info->model, info->parent_node);
