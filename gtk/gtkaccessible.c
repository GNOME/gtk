...
static const char *role_names[] = {
  ...
  [GTK_ACCESSIBLE_ROLE_AUTHOR_CONTROLLED_PARENT] = NC_("accessibility", "author-controlled parent"),
...
static struct {
  ...
  { GTK_ACCESSIBLE_ROLE_STRUCTURE, GTK_ACCESSIBLE_ROLE_AUTHOR_CONTROLLED_PARENT },
