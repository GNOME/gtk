      ...
      for (l = children; l != NULL; l = l->next)
        {
          ...
          if (has_default)
            {
              gtk_window_set_default (GTK_WINDOW (assistant), child);
...
update_buttons_state (GtkAssistant *assistant)
{
  ...
  switch (priv->current_page->type)
    ...
    case GTK_ASSISTANT_PAGE_INTRO:
      ...
      gtk_window_set_default (GTK_WINDOW (assistant), priv->forward);
      gtk_widget_show (priv->forward);
    ...
    case GTK_ASSISTANT_PAGE_CONFIRM:
      ...
      gtk_window_set_default (GTK_WINDOW (assistant), priv->apply);
    ...
    case GTK_ASSISTANT_PAGE_SUMMARY:
      ...
      gtk_window_set_default (GTK_WINDOW (assistant), priv->close);
