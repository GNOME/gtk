...
void                    gtk_allocation_details_set_baseline             (GtkAllocationDetails          *self,
                                                                         int                            baseline);
GDK_AVAILABLE_IN_4_26
int                     gtk_allocation_details_get_baseline             (const GtkAllocationDetails    *self) G_GNUC_PURE;
GDK_AVAILABLE_IN_4_26
void                    gtk_allocation_details_set_transform            (GtkAllocationDetails          *self,
                                                                         GskTransform                  *transform);
GDK_AVAILABLE_IN_4_26
GskTransform *          gtk_allocation_details_get_transform            (const GtkAllocationDetails    *self) G_GNUC_PURE;
