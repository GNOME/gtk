...
#define GTK_TYPE_TEXT_VIEW_TAG (gtk_text_tag_get_type())
#define GTK_TEXT_TAG(obj)  (GTK_CHECK_CAST ((obj), GTK_TYPE_TEXT_VIEW_TAG, GtkTextTag))
#define GTK_TEXT_TAG_CLASS(klass)  (GTK_CHECK_CLASS_CAST ((klass), GTK_TYPE_TEXT_VIEW_TAG, GtkTextTagClass))
#define GTK_IS_TEXT_VIEW_TAG(obj)  (GTK_CHECK_TYPE ((obj), GTK_TYPE_TEXT_VIEW_TAG))
#define GTK_IS_TEXT_VIEW_TAG_CLASS(klass)  (GTK_CHECK_CLASS_TYPE ((klass), GTK_TYPE_TEXT_VIEW_TAG))
