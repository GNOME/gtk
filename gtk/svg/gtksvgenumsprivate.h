...
typedef enum {
  ...
  DOMINANT_BASELINE_TEXT_BEFORE_EDGE,
  // CSS3
  DOMINANT_BASELINE_TEXT_TOP,
  DOMINANT_BASELINE_TEXT_BOTTOM
} DominantBaseline;
...
typedef enum {
  UNICODE_BIDI_NORMAL,
  UNICODE_BIDI_EMBED,
  UNICODE_BIDI_ISOLATE,
  UNICODE_BIDI_OVERRIDE,
  UNICODE_BIDI_ISOLATE_OVERRIDE,
  UNICODE_BIDI_PLAINTEXT,
} UnicodeBidi;
...
typedef enum
{
  ...
  POINTER_EVENTS_VISIBLE_PAINTED,
  POINTER_EVENTS_VISIBLE_FILL,
  POINTER_EVENTS_VISIBLE_STROKE,
