...
DEFINE_ENUM (DOMINANT_BASELINE, dominant_baseline, DominantBaseline,
  DEFINE_ENUM_VALUE (DOMINANT_BASELINE, DOMINANT_BASELINE_AUTO, "auto"),
  DEFINE_ENUM_VALUE (DOMINANT_BASELINE, DOMINANT_BASELINE_IDEOGRAPHIC, "ideographic"),
  DEFINE_ENUM_VALUE (DOMINANT_BASELINE, DOMINANT_BASELINE_ALPHABETIC, "alphabetic"),
  DEFINE_ENUM_VALUE (DOMINANT_BASELINE, DOMINANT_BASELINE_HANGING, "hanging"),
  DEFINE_ENUM_VALUE (DOMINANT_BASELINE, DOMINANT_BASELINE_MATHEMATICAL, "mathematical"),
  DEFINE_ENUM_VALUE (DOMINANT_BASELINE, DOMINANT_BASELINE_CENTRAL, "central"),
  DEFINE_ENUM_VALUE (DOMINANT_BASELINE, DOMINANT_BASELINE_MIDDLE, "middle"),
  DEFINE_ENUM_VALUE (DOMINANT_BASELINE, DOMINANT_BASELINE_TEXT_AFTER_EDGE, "text-after-edge"),
  DEFINE_ENUM_VALUE (DOMINANT_BASELINE, DOMINANT_BASELINE_TEXT_BEFORE_EDGE, "text-before-edge"),

  DEFINE_ENUM_VALUE (DOMINANT_BASELINE, DOMINANT_BASELINE_TEXT_TOP, "text-top"),
  DEFINE_ENUM_VALUE (DOMINANT_BASELINE, DOMINANT_BASELINE_TEXT_BOTTOM, "text-bottom")
)
...
static SvgValue *
svg_font_width_resolve (const SvgValue    *value,
                        SvgProperty        attr,
                        unsigned int       idx,
                        SvgElement        *shape,
                        SvgComputeContext *context)
{
  const SvgEnum *font_width = (const SvgEnum *) value;

  g_assert (attr == SVG_PROPERTY_FONT_WIDTH);

  return svg_percentage_new (font_width->value * 0.1);
}

DEFINE_ENUM_CUSTOM_RESOLVE (FONT_WIDTH, font_width, PangoWidth, svg_font_width_resolve,
  DEFINE_ENUM_VALUE (FONT_WIDTH, PANGO_WIDTH_ULTRA_CONDENSED, "ultra-condensed"),
  DEFINE_ENUM_VALUE (FONT_WIDTH, PANGO_WIDTH_EXTRA_CONDENSED, "extra-condensed"),
  DEFINE_ENUM_VALUE (FONT_WIDTH, PANGO_WIDTH_CONDENSED, "condensed"),
  DEFINE_ENUM_VALUE (FONT_WIDTH, PANGO_WIDTH_SEMI_CONDENSED, "semi-condensed"),
  DEFINE_ENUM_VALUE (FONT_WIDTH, PANGO_WIDTH_NORMAL, "normal"),
  DEFINE_ENUM_VALUE (FONT_WIDTH, PANGO_WIDTH_SEMI_EXPANDED, "semi-expanded"),
  DEFINE_ENUM_VALUE (FONT_WIDTH, PANGO_WIDTH_EXPANDED, "expanded"),
  DEFINE_ENUM_VALUE (FONT_WIDTH, PANGO_WIDTH_EXTRA_EXPANDED, "extra-expanded"),
  DEFINE_ENUM_VALUE (FONT_WIDTH, PANGO_WIDTH_ULTRA_EXPANDED, "ultra-expanded")
)
