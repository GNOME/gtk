...
static SvgPropertyInfo shape_attrs[] = {
  ...
  [SVG_PROPERTY_X] = {
    .applies_to = BIT (SVG_ELEMENT_SVG) | BIT (SVG_ELEMENT_RECT) | BIT (SVG_ELEMENT_IMAGE) |
...
static SvgPropertyLookup shape_attr_lookups[] = {
  ...
  { "x",  BIT (SVG_ELEMENT_SVG) | BIT (SVG_ELEMENT_RECT) | BIT (SVG_ELEMENT_IMAGE) |
          BIT (SVG_ELEMENT_USE) | BIT (SVG_ELEMENT_FILTER) | BIT (SVG_ELEMENT_PATTERN) |
          BIT (SVG_ELEMENT_MASK) | ELEMENT_TEXTS, 0, SVG_PROPERTY_X },
  { "y",  BIT (SVG_ELEMENT_SVG) | BIT (SVG_ELEMENT_RECT) | BIT (SVG_ELEMENT_IMAGE) |
          BIT (SVG_ELEMENT_USE) | BIT (SVG_ELEMENT_FILTER) | BIT (SVG_ELEMENT_PATTERN) |
          BIT (SVG_ELEMENT_MASK) | ELEMENT_TEXTS, 0, SVG_PROPERTY_Y },
  { "width", BIT (SVG_ELEMENT_SVG) | BIT (SVG_ELEMENT_RECT) | BIT (SVG_ELEMENT_IMAGE) |
  ...
  { "height", BIT (SVG_ELEMENT_SVG) | BIT (SVG_ELEMENT_RECT) | BIT (SVG_ELEMENT_IMAGE) |
              BIT (SVG_ELEMENT_USE) | BIT (SVG_ELEMENT_FILTER) | BIT (SVG_ELEMENT_MASK) |
