...
static void gtk_text_tag_finalize (GtkObject *object);
static void gtk_text_tag_set_arg (GtkObject *object, GtkArg *arg, guint arg_id);
static void gtk_text_tag_get_arg (GtkObject *object, GtkArg *arg, guint arg_id);
static void gtk_marshal_INT__OBJECT_EVENT_POINTER (GtkObject  *object,
                                                   GtkSignalFunc func,
                                                   gpointer func_data,
                                                   GtkArg  *args);
...
gtk_text_tag_class_init (GtkTextTagClass *klass)
{
  ...
  signals[EVENT] =
    gtk_signal_new ("event",
                    ...
                    gtk_marshal_INT__OBJECT_EVENT_POINTER,
                    GTK_TYPE_INT,
                    3,
                    GTK_TYPE_OBJECT,
                    GTK_TYPE_GDK_EVENT,
...
static void
gtk_text_tag_finalize (GtkObject *object)
{
  GtkTextTag *tkxt_tag;
...
typedef gint (*GtkSignal_INT__OBJECT_EVENT_POINTER) (GtkObject  *object,
                                                     GtkObject  *event_object,
                                                     GdkEvent *event,
                                                     const GtkTextIter *iter,
                                                     gpointer user_data);
...
void 
gtk_marshal_INT__OBJECT_EVENT_POINTER (GtkObject  *object,
                                       GtkSignalFunc func,
                                       gpointer func_data,
                                       GtkArg  *args)
{
  gint *return_val;
  GtkSignal_INT__OBJECT_EVENT_POINTER rfunc;

  
  return_val = GTK_RETLOC_INT (args[3]);

  rfunc = (GtkSignal_INT__OBJECT_EVENT_POINTER) func;
