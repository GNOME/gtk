 ...
 * @GTK_SYSTEM_SETTING_FONT_CONFIG: The font configuration has changed. This can
 *     be any of the #GtkSettings:gtk-xft-antialias, #GtkSettings:gtk-xft-hinting,
 ...
 * @GTK_SYSTEM_SETTING_ICON_THEME: The #GtkSettings:gtk-icon-theme-name setting has changed
 * @GTK_SYSTEM_SETTING_THEME: The #GtkSettings:gtk-theme-name or #GtkSettings:gtk-aplication-prefer-dark-theme settings have changed
 * @GTK_SYSTEM_SETTING_ANIMATIONS: The #GtkSettings:gtk-enable-animations setting has changed
 *
