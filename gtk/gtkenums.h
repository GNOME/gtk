 ...
 * @GTK_ANNOUNCEMENT_PRIORITY_MEDIUM: The announcement is of medium priority, and is usually spoken at the next opportunity,
 ...
 * Because an interruption might disorient users or cause them to not complete their current task,
 * authors SHOULD NOT use high priority announcements unless the interruption is imperative.
 * An example would be a notification about a critical battery power level.
 * 
