...
GTK_DECLARE_EXPORTED_TYPE (GtkMultiFilter, gtk_multi_filter, GTK, MULTI_FILTER)
...
GDK_AVAILABLE_IN_ALL
GTK_DECLARE_EXPORTED_TYPE (GtkAnyFilter, gtk_any_filter, GTK, ANY_FILTER)
GDK_AVAILABLE_IN_ALL
GtkFilter *             gtk_any_filter_new                      (void);

#define GTK_TYPE_EVERY_FILTER             (gtk_every_filter_get_type ())
GDK_AVAILABLE_IN_ALL
GTK_DECLARE_EXPORTED_TYPE (GtkEveryFilter, gtk_every_filter, GTK, EVERY_FILTER)
GDK_AVAILABLE_IN_ALL
