...
#define GTK_PARAM_READABLE G_PARAM_READABLE|G_PARAM_STATIC_NAME
#define GTK_PARAM_WRITABLE G_PARAM_WRITABLE|G_PARAM_STATIC_NAME
#define GTK_PARAM_READWRITE G_PARAM_READWRITE|G_PARAM_STATIC_NAME
