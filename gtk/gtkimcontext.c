                             ...
                             GdkEventKey  *key)
{
  ...
  no_text_input_mask = gdk_keymap_get_modifier_mask (
    gdk_display_get_keymap (gdk_event_get_display (event)),
				...
				GdkEventKey  *key)
{
  ...
  g_set_object (&priv->display, gdk_event_get_display (event));
                              ...
                              const GdkEvent *event)
{
  ...
  gdk_display_put_event (gdk_event_get_display (copy), copy);
  g_object_unref (copy);
}
