...
GDK_AVAILABLE_IN_ALL
GtkWidget *  gtk_window_controls_new                   (GtkPackType        pack_type);

GDK_AVAILABLE_IN_ALL
GtkPackType  gtk_window_controls_get_pack_type         (GtkWindowControls *self);

GDK_AVAILABLE_IN_ALL
void         gtk_window_controls_set_pack_type         (GtkWindowControls *self,
