...
gtk_text_class_init (GtkTextClass *class)
{
  ...
  text_props[PROP_MAX_UNDO_LEVELS] =
    g_param_spec_uint ("max-undo-levels",
                       "Max Undo Levels",
                       "The maximum number of undo actions to store while editing",
  ...
  */
   ...
   * changes to the text is allowed.
   */
                       ...
                       GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_MAX_UNDO_LEVELS:
      gtk_text_history_set_max_undo_levels (priv->history, g_value_get_uint (value));
      break;
                       ...
                       GParamSpec *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_MAX_UNDO_LEVELS:
      g_value_set_uint (value, gtk_text_history_get_max_undo_levels (priv->history));
      break;
...
gtk_text_init (GtkText *self)
{
  ...
  gtk_text_history_set_enabled (priv->history, FALSE);
