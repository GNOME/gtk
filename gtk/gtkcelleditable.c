...
gtk_cell_editable_default_init (GtkCellEditableInterface *iface)
{
   ...
   * #GtkEntry emits it when the user presses Enter or focuses out of the entry.
   * Typical things to do in a handler for this are to capture the edited
   * value, disconnect @cell_editable from signals on the #GtkCellRenderer, etc.
   *
