...
to_rotate_coords (GtkImageView *self,
                  ...
                  double       *out_y)
{
  const double cx = state->hupper / 2.0 - state->hvalue;
  const double cy = state->vupper / 2.0 - state->vvalue;
 ...
 *
 * Replate the current contents of the image view with the given paintable
 *
 * Since: 4.0
 */
void
