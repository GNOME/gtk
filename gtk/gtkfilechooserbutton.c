                               ...
                               gpointer      user_data)
{
  ...
  g_clear_object (&button->dnd_select_folder_cancellable);
  ...
  button->dnd_select_folder_cancellable = g_cancellable_new ();
  ...
  if (button->change_icon_theme_cancellables)
    {
      ...
      g_slist_free_full (button->change_icon_theme_cancellables, g_object_unref);
