                                             ...
                                             GtkSelectionFilterModel *self)
{
  ...
  sel_position = gtk_bitset_get_size_in_range (self->selection, 0, position);
  sel_removed = gtk_bitset_get_size_in_range (self->selection, position, removed);
  sel_added = gtk_bitset_get_size_in_range (selection, position, added);
                                                 ...
                                                 GtkSelectionFilterModel *self)
{
  ...
  sel_position = gtk_bitset_get_size_in_range (self->selection, 0, position);
  sel_removed = gtk_bitset_get_size_in_range (self->selection, position, n_items);
  sel_added = gtk_bitset_get_size_in_range (selection, position, n_items);
