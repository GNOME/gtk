...
gtk_inspector_recorder_row_class_init (GtkInspectorRecorderRowClass *klass)
{
  ...
  props[PROP_SEQUENCE] = g_param_spec_pointer ("sequence", NULL, NULL, G_PARAM_READWRITE | G_PARAM_STATIC_NAME);
  props[PROP_MATCH_SEQUENCE] = g_param_spec_pointer ("match-sequence", NULL, NULL, G_PARAM_READWRITE | G_PARAM_STATIC_NAME);
