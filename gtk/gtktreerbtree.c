...
static GtkTreeRBNode * _gtk_tree_rbnode_new                (GtkTreeRBTree  *tree,
						   gint        height);
static void        _gtk_tree_rbnode_free               (GtkTreeRBNode  *node);
static void        _gtk_tree_rbnode_rotate_left        (GtkTreeRBTree  *tree,
						   GtkTreeRBNode  *node);
static void        _gtk_tree_rbnode_rotate_right       (GtkTreeRBTree  *tree,
						   GtkTreeRBNode  *node);
static void        _gtk_tree_rbtree_insert_fixup       (GtkTreeRBTree  *tree,
						   GtkTreeRBNode  *node);
static void        _gtk_tree_rbtree_remove_node_fixup  (GtkTreeRBTree  *tree,
						   GtkTreeRBNode  *node,
                                                   GtkTreeRBNode  *parent);
static inline void _fixup_validation              (GtkTreeRBTree  *tree,
						   GtkTreeRBNode  *node);
static inline void _fixup_total_count             (GtkTreeRBTree  *tree,
						   GtkTreeRBNode  *node);
#ifdef G_ENABLE_DEBUG
static void        _gtk_tree_rbtree_test               (const gchar *where,
                                                   GtkTreeRBTree  *tree);
static void        _gtk_tree_rbtree_debug_spew         (GtkTreeRBTree  *tree,
                                                   GString    *s);
#endif
...
gboolean
_gtk_tree_rbtree_is_nil (GtkTreeRBNode *node)
{
  return node == &nil;
}

static GtkTreeRBNode *
_gtk_tree_rbnode_new (GtkTreeRBTree *tree,
		 gint       height)
{
...
static void
_gtk_tree_rbnode_free (GtkTreeRBNode *node)
{
#ifdef G_ENABLE_DEBUG
...
static void
_gtk_tree_rbnode_rotate_left (GtkTreeRBTree *tree,
			 GtkTreeRBNode *node)
{
  gint node_height, right_height;
  GtkTreeRBNode *right;

  g_return_if_fail (!_gtk_tree_rbtree_is_nil (node));
  g_return_if_fail (!_gtk_tree_rbtree_is_nil (node->right));
  ...
  if (!_gtk_tree_rbtree_is_nil (right->left))
    right->left->parent = node;

  right->parent = node->parent;
  if (!_gtk_tree_rbtree_is_nil (node->parent))
    {
...
static void
_gtk_tree_rbnode_rotate_right (GtkTreeRBTree *tree,
			  GtkTreeRBNode *node)
{
  ...
  g_return_if_fail (!_gtk_tree_rbtree_is_nil (node));
  g_return_if_fail (!_gtk_tree_rbtree_is_nil (node->left));
  ...
  if (!_gtk_tree_rbtree_is_nil (left->right))
...
static void
_gtk_tree_rbtree_insert_fixup (GtkTreeRBTree *tree,
			  GtkTreeRBNode *node)
{
      ...
      if (node->parent == node->parent->parent->left)
	{
	  ...
	  if (GTK_TREE_RBNODE_GET_COLOR (y) == GTK_TREE_RBNODE_RED)
	      ...
	      if (node == node->parent->right)
		{
		  ...
		  node = node->parent;
		  _gtk_tree_rbnode_rotate_left (tree, node);
		}

				/* recolor and rotate */
	      GTK_TREE_RBNODE_SET_COLOR (node->parent, GTK_TREE_RBNODE_BLACK);
	      GTK_TREE_RBNODE_SET_COLOR (node->parent->parent, GTK_TREE_RBNODE_RED);
	      _gtk_tree_rbnode_rotate_right(tree, node->parent->parent);
	    }
	}
      else
	{
	  ...
	  if (GTK_TREE_RBNODE_GET_COLOR (y) == GTK_TREE_RBNODE_RED)
		...
		{
		  node = node->parent;
		  _gtk_tree_rbnode_rotate_right (tree, node);
		}
	      GTK_TREE_RBNODE_SET_COLOR (node->parent, GTK_TREE_RBNODE_BLACK);
	      GTK_TREE_RBNODE_SET_COLOR (node->parent->parent, GTK_TREE_RBNODE_RED);
	      _gtk_tree_rbnode_rotate_left (tree, node->parent->parent);
	    }
	}
    }
...
static void
_gtk_tree_rbtree_remove_node_fixup (GtkTreeRBTree *tree,
			       GtkTreeRBNode *node,
                               GtkTreeRBNode *parent)
{
      ...
      if (node == parent->left)
	{
	  ...
	  if (GTK_TREE_RBNODE_GET_COLOR (w) == GTK_TREE_RBNODE_RED)
	    {
	      ...
	      _gtk_tree_rbnode_rotate_left (tree, parent);
	      w = parent->right;
	    }
	  if (GTK_TREE_RBNODE_GET_COLOR (w->left) == GTK_TREE_RBNODE_BLACK && GTK_TREE_RBNODE_GET_COLOR (w->right) == GTK_TREE_RBNODE_BLACK)
	      ...
	      if (GTK_TREE_RBNODE_GET_COLOR (w->right) == GTK_TREE_RBNODE_BLACK)
		{
		  ...
		  GTK_TREE_RBNODE_SET_COLOR (w, GTK_TREE_RBNODE_RED);
		  _gtk_tree_rbnode_rotate_right (tree, w);
		  w = parent->right;
		}
      ...
      else
	{
	  ...
	  if (GTK_TREE_RBNODE_GET_COLOR (w) == GTK_TREE_RBNODE_RED)
	    {
	      GTK_TREE_RBNODE_SET_COLOR (w, GTK_TREE_RBNODE_BLACK);
	      GTK_TREE_RBNODE_SET_COLOR (parent, GTK_TREE_RBNODE_RED);
	      _gtk_tree_rbnode_rotate_right (tree, parent);
	      w = parent->left;
	    }
	  if (GTK_TREE_RBNODE_GET_COLOR (w->right) == GTK_TREE_RBNODE_BLACK && GTK_TREE_RBNODE_GET_COLOR (w->left) == GTK_TREE_RBNODE_BLACK)
	      ...
	      if (GTK_TREE_RBNODE_GET_COLOR (w->left) == GTK_TREE_RBNODE_BLACK)
		{
		  GTK_TREE_RBNODE_SET_COLOR (w->right, GTK_TREE_RBNODE_BLACK);
		  GTK_TREE_RBNODE_SET_COLOR (w, GTK_TREE_RBNODE_RED);
		  _gtk_tree_rbnode_rotate_left (tree, w);
		  w = parent->left;
		}
	      GTK_TREE_RBNODE_SET_COLOR (w, GTK_TREE_RBNODE_GET_COLOR (parent));
	      GTK_TREE_RBNODE_SET_COLOR (parent, GTK_TREE_RBNODE_BLACK);
...
static void
_gtk_tree_rbtree_free_helper (GtkTreeRBTree  *tree,
			 GtkTreeRBNode  *node,
			 gpointer    data)
{
  if (node->children)
    _gtk_tree_rbtree_free (node->children);

  _gtk_tree_rbnode_free (node);
}

void
_gtk_tree_rbtree_free (GtkTreeRBTree *tree)
{
  _gtk_tree_rbtree_traverse (tree,
			tree->root,
			G_POST_ORDER,
			_gtk_tree_rbtree_free_helper,
			NULL);
...
gtk_rbnode_adjust (GtkTreeRBTree *tree,
                   ...
                   int        offset_diff)
{
  while (tree && node && !_gtk_tree_rbtree_is_nil (node))
    {
      _fixup_validation (tree, node);
...
void
_gtk_tree_rbtree_remove (GtkTreeRBTree *tree)
{
#ifdef G_ENABLE_DEBUG
  GtkTreeRBTree *tmp_tree;

  if (GTK_DEBUG_CHECK (TREE))
    _gtk_tree_rbtree_test (G_STRLOC, tree);
#endif
...
#ifdef G_ENABLE_DEBUG
  if (GTK_DEBUG_CHECK (TREE))
    _gtk_tree_rbtree_test (G_STRLOC, tmp_tree);
#endif
}


GtkTreeRBNode *
_gtk_tree_rbtree_insert_after (GtkTreeRBTree *tree,
			  ...
			  gboolean   valid)
{
  ...
  if (GTK_DEBUG_CHECK (TREE))
    {
      ...
      s = g_string_new ("");
      g_string_append_printf (s, "_gtk_tree_rbtree_insert_after: %p\n", current);
      _gtk_tree_rbtree_debug_spew (tree, s);
      g_message ("%s", s->str);
  ...
  if (current != NULL && !_gtk_tree_rbtree_is_nil (current->right))
    {
      current = current->right;
      while (!_gtk_tree_rbtree_is_nil (current->left))
	current = current->left;
      right = FALSE;
    }
  /* setup new node */
  node = _gtk_tree_rbnode_new (tree, height);
  ...
  if (current)
    ...
    {
      g_assert (_gtk_tree_rbtree_is_nil (tree->root));
      tree->root = node;
  ...
  if (valid)
    _gtk_tree_rbtree_node_mark_valid (tree, node);
  else
    _gtk_tree_rbtree_node_mark_invalid (tree, node);

  _gtk_tree_rbtree_insert_fixup (tree, node);
  ...
  if (GTK_DEBUG_CHECK (TREE))
    {
      ...
      s = g_string_new ("_gtk_tree_rbtree_insert_after finished...\n");
      _gtk_tree_rbtree_debug_spew (tree, s);
      g_message ("%s", s->str);
      g_string_free (s, TRUE);
      _gtk_tree_rbtree_test (G_STRLOC, tree);
...
GtkTreeRBNode *
_gtk_tree_rbtree_insert_before (GtkTreeRBTree *tree,
			   GtkTreeRBNode *current,
			   gint       height,
			   gboolean   valid)
{
  ...
  if (GTK_DEBUG_CHECK (TREE))
    {
      ...
      s = g_string_new ("");
      g_string_append_printf (s, "_gtk_tree_rbtree_insert_before: %p\n", current);
      _gtk_tree_rbtree_debug_spew (tree, s);
      g_message ("%s", s->str);
      g_string_free (s, TRUE);
      _gtk_tree_rbtree_test (G_STRLOC, tree);
  ...
  if (current != NULL && !_gtk_tree_rbtree_is_nil (current->left))
    {
      current = current->left;
      while (!_gtk_tree_rbtree_is_nil (current->right))
	current = current->right;
      left = FALSE;
    }
  ...
  if (GTK_DEBUG_CHECK (TREE))
    {
      ...
      s = g_string_new ("_gtk_tree_rbtree_insert_before finished...\n");
      _gtk_tree_rbtree_debug_spew (tree, s);
      g_message ("%s", s->str);
      g_string_free (s, TRUE);
      _gtk_tree_rbtree_test (G_STRLOC, tree);
...
GtkTreeRBNode *
_gtk_tree_rbtree_find_count (GtkTreeRBTree *tree,
			gint       count)
{
  GtkTreeRBNode *node;

  node = tree->root;
  while (!_gtk_tree_rbtree_is_nil (node) && (node->left->count + 1 != count))
    {
...
void
_gtk_tree_rbtree_node_set_height (GtkTreeRBTree *tree,
			     GtkTreeRBNode *node,
			     gint       height)
{
...
void
_gtk_tree_rbtree_node_mark_invalid (GtkTreeRBTree *tree,
			       GtkTreeRBNode *node)
{
...
void
_gtk_tree_rbtree_node_mark_valid (GtkTreeRBTree *tree,
			     GtkTreeRBNode *node)
{
  if ((!GTK_TREE_RBNODE_FLAG_SET (node, GTK_TREE_RBNODE_INVALID)) &&
 ...
 */
void
_gtk_tree_rbtree_column_invalid (GtkTreeRBTree *tree)
{
  GtkTreeRBNode *node;
  ...
  do
	...
	GTK_TREE_RBNODE_SET_FLAG (node, GTK_TREE_RBNODE_COLUMN_INVALID);
      ...
      if (node->children)
	_gtk_tree_rbtree_column_invalid (node->children);
    }
  while ((node = _gtk_tree_rbtree_next (tree, node)) != NULL);
}

void
_gtk_tree_rbtree_mark_invalid (GtkTreeRBTree *tree)
{
  GtkTreeRBNode *node;
  ...
  do
    {
      ...
      if (node->children)
	_gtk_tree_rbtree_mark_invalid (node->children);
    }
  while ((node = _gtk_tree_rbtree_next (tree, node)) != NULL);
}

void
_gtk_tree_rbtree_set_fixed_height (GtkTreeRBTree *tree,
			      gint       height,
			      gboolean   mark_valid)
{
  GtkTreeRBNode *node;
  ...
  do
    {
      if (GTK_TREE_RBNODE_FLAG_SET (node, GTK_TREE_RBNODE_INVALID))
        {
	  _gtk_tree_rbtree_node_set_height (tree, node, height);
	  if (mark_valid)
	    _gtk_tree_rbtree_node_mark_valid (tree, node);
	}

      if (node->children)
	_gtk_tree_rbtree_set_fixed_height (node->children, height, mark_valid);
    }
  while ((node = _gtk_tree_rbtree_next (tree, node)) != NULL);
}
                   ...
                   GtkTreeRBNode *from)
{
  ...
  to->left = from->left;
  if (!_gtk_tree_rbtree_is_nil (to->left))
    to->left->parent = to;

  to->right = from->right;
  if (!_gtk_tree_rbtree_is_nil (to->right))
    to->right->parent = to;

  to->parent = from->parent;
  if (_gtk_tree_rbtree_is_nil (to->parent))
    tree->root = to;
 ...
 */
void
_gtk_tree_rbtree_reorder (GtkTreeRBTree *tree,
		     gint      *new_order,
		     gint       length)
{
  GtkTreeRBNode **nodes;
  ...
  _gtk_tree_rbtree_traverse (tree, tree->root, G_PRE_ORDER, reorder_prepare, NULL);
  ...
  _gtk_tree_rbtree_traverse (tree, tree->root, G_POST_ORDER, reorder_fixup, NULL);

  g_free (nodes);
}

/**
 * _gtk_tree_rbtree_contains:
 * @tree: a tree
 ...
 **/
gboolean
_gtk_tree_rbtree_contains (GtkTreeRBTree *tree,
...
gint
_gtk_tree_rbtree_node_find_offset (GtkTreeRBTree *tree,
			      GtkTreeRBNode *node)
{
  GtkTreeRBNode *last;
  gint retval;
...
guint
_gtk_tree_rbtree_node_get_index (GtkTreeRBTree *tree,
                            GtkTreeRBNode *node)
{
  GtkTreeRBNode *last;
  guint retval;  
			     ...
			     GtkTreeRBNode **new_node)
{
  ...
  tmp_node = tree->root;
  while (!_gtk_tree_rbtree_is_nil (tmp_node) &&
  ...
  if (_gtk_tree_rbtree_is_nil (tmp_node))
    {
      *new_tree = NULL;
      *new_node = NULL;
      return 0;
...
gint
_gtk_tree_rbtree_find_offset (GtkTreeRBTree  *tree,
			 gint        height,
			 GtkTreeRBTree **new_tree,
			 GtkTreeRBNode **new_node)
{
...
gboolean
_gtk_tree_rbtree_find_index (GtkTreeRBTree  *tree,
                        guint       index,
                        GtkTreeRBTree **new_tree,
                        GtkTreeRBNode **new_node)
{
  ...
  if (index > 0)
    {
      ...
      return _gtk_tree_rbtree_find_index (tmp_node->children,
                                     index - 1,
                                     new_tree,
                                     new_node);
    }
...
void
_gtk_tree_rbtree_remove_node (GtkTreeRBTree *tree,
			 GtkTreeRBNode *node)
{
  GtkTreeRBNode *x, *y;
  gint y_height;
  ...
  if (GTK_DEBUG_CHECK (TREE))
    {
      ...
      s = g_string_new ("");
      g_string_append_printf (s, "_gtk_tree_rbtree_remove_node: %p\n", node);
      _gtk_tree_rbtree_debug_spew (tree, s);
      g_message ("%s", s->str);
      g_string_free (s, TRUE);
      _gtk_tree_rbtree_test (G_STRLOC, tree);
  ...
  for (x = node; !_gtk_tree_rbtree_is_nil (x->parent); x = x->parent)
    ;
  ...
  if (_gtk_tree_rbtree_is_nil (node->left) ||
      _gtk_tree_rbtree_is_nil (node->right))
    {
      y = node;
    }
  else
    {
      ...
      while (!_gtk_tree_rbtree_is_nil (y->left))
	y = y->left;
    }
  ...
  if (!_gtk_tree_rbtree_is_nil (y->left))
    x = y->left;
  else
    x = y->right;

  /* remove y from the parent chain */
  if (!_gtk_tree_rbtree_is_nil (x))
    x->parent = y->parent;
  if (!_gtk_tree_rbtree_is_nil (y->parent))
    {
      if (y == y->parent->left)
	y->parent->left = x;
      else
  ...
  if (GTK_TREE_RBNODE_GET_COLOR (y) == GTK_TREE_RBNODE_BLACK)
    _gtk_tree_rbtree_remove_node_fixup (tree, x, y->parent);
  ...
  if (y != node)
	...
	y->flags ^= (GTK_TREE_RBNODE_BLACK | GTK_TREE_RBNODE_RED);
      ...
      if (!_gtk_tree_rbtree_is_nil (y->left))
        y->left->parent = y;
      y->right = node->right;
      if (!_gtk_tree_rbtree_is_nil (y->right))
        y->right->parent = y;
  ...
  if (GTK_DEBUG_CHECK (TREE))
    {
      ...
      s = g_string_new ("_gtk_tree_rbtree_remove_node finished...\n");
      _gtk_tree_rbtree_debug_spew (tree, s);
      g_message ("%s", s->str);
      g_string_free (s, TRUE);
      _gtk_tree_rbtree_test (G_STRLOC, tree);
...
GtkTreeRBNode *
_gtk_tree_rbtree_first (GtkTreeRBTree *tree)
{
  GtkTreeRBNode *node;
  ...
  while (!_gtk_tree_rbtree_is_nil (node->left))
    node = node->left;
...
GtkTreeRBNode *
_gtk_tree_rbtree_next (GtkTreeRBTree *tree,
		  GtkTreeRBNode *node)
{
  ...
  while (!_gtk_tree_rbtree_is_nil (node->parent))
    {
...
GtkTreeRBNode *
_gtk_tree_rbtree_prev (GtkTreeRBTree *tree,
		  GtkTreeRBNode *node)
{
  g_return_val_if_fail (tree != NULL, NULL);
  g_return_val_if_fail (node != NULL, NULL);
  ...
  if (!_gtk_tree_rbtree_is_nil (node->left))
    {
      node = node->left;
      while (!_gtk_tree_rbtree_is_nil (node->right))
	node = node->right;
      return node;
    }
...
void
_gtk_tree_rbtree_next_full (GtkTreeRBTree  *tree,
		       GtkTreeRBNode  *node,
		       GtkTreeRBTree **new_tree,
		       GtkTreeRBNode **new_node)
{
  ...
  if (node->children)
    {
      ...
      *new_node = (*new_tree)->root;
      while (!_gtk_tree_rbtree_is_nil ((*new_node)->left))
	*new_node = (*new_node)->left;
      return;
    }

  *new_tree = tree;
  *new_node = _gtk_tree_rbtree_next (tree, node);
  ...
  while ((*new_node == NULL) &&
	 (*new_tree != NULL))
    {
      ...
      *new_tree = (*new_tree)->parent_tree;
      if (*new_tree)
	*new_node = _gtk_tree_rbtree_next (*new_tree, *new_node);
    }
}

void
_gtk_tree_rbtree_prev_full (GtkTreeRBTree  *tree,
		       GtkTreeRBNode  *node,
		       GtkTreeRBTree **new_tree,
		       GtkTreeRBNode **new_node)
{
  ...
  *new_tree = tree;
  *new_node = _gtk_tree_rbtree_prev (tree, node);
  ...
  if (*new_node == NULL)
      ...
      while ((*new_node)->children)
	{
	  ...
	  *new_node = (*new_tree)->root;
          while (!_gtk_tree_rbtree_is_nil ((*new_node)->right))
...
gint
_gtk_tree_rbtree_get_depth (GtkTreeRBTree *tree)
{
  GtkTreeRBTree *tmp_tree;
  gint depth = 0;
...
static void
_gtk_tree_rbtree_traverse_pre_order (GtkTreeRBTree             *tree,
				GtkTreeRBNode             *node,
				...
				gpointer               data)
{
  ...
  (* func) (tree, node, data);
  _gtk_tree_rbtree_traverse_pre_order (tree, node->left, func, data);
  _gtk_tree_rbtree_traverse_pre_order (tree, node->right, func, data);
}

static void
_gtk_tree_rbtree_traverse_post_order (GtkTreeRBTree             *tree,
				 GtkTreeRBNode             *node,
				 GtkTreeRBTreeTraverseFunc  func,
				 gpointer               data)
{
  ...
  _gtk_tree_rbtree_traverse_post_order (tree, node->left, func, data);
  _gtk_tree_rbtree_traverse_post_order (tree, node->right, func, data);
  (* func) (tree, node, data);
}

void
_gtk_tree_rbtree_traverse (GtkTreeRBTree             *tree,
		      GtkTreeRBNode             *node,
		      GTraverseType          order,
		      GtkTreeRBTreeTraverseFunc  func,
		      gpointer               data)
{
  ...
  switch (order)
    {
    case G_PRE_ORDER:
      _gtk_tree_rbtree_traverse_pre_order (tree, node, func, data);
      break;
    case G_POST_ORDER:
      _gtk_tree_rbtree_traverse_post_order (tree, node, func, data);
      break;
    case G_IN_ORDER:
    case G_LEVEL_ORDER:
    default:
...
static inline
void _fixup_validation (GtkTreeRBTree *tree,
			GtkTreeRBNode *node)
{
  if (GTK_TREE_RBNODE_FLAG_SET (node, GTK_TREE_RBNODE_INVALID) ||
      GTK_TREE_RBNODE_FLAG_SET (node, GTK_TREE_RBNODE_COLUMN_INVALID) ||
...
static inline
void _fixup_total_count (GtkTreeRBTree *tree,
		    GtkTreeRBNode *node)
{
  node->total_count = 1 +
  ...
  if (!_gtk_tree_rbtree_is_nil (node->left))
    {
      ...
      _gtk_tree_rbtree_test_structure_helper (tree, node->left);
    }
  if (!_gtk_tree_rbtree_is_nil (node->right))
    {
      g_assert (node->right->parent == node);
      _gtk_tree_rbtree_test_structure_helper (tree, node->right);
    }
...
static void
_gtk_tree_rbtree_test (const gchar *where,
                  GtkTreeRBTree   *tree)
{
  GtkTreeRBTree *tmp_tree;
...
static void
_gtk_tree_rbtree_debug_spew_helper (GtkTreeRBTree *tree,
			       GtkTreeRBNode *node,
                               GString   *s,
			       gint       depth)
{
  ...
  if (node->children != NULL)
    {
      ...
      _gtk_tree_rbtree_debug_spew (node->children, s);
      g_string_append (s, "Done looking at child.\n");
    }
  if (!_gtk_tree_rbtree_is_nil (node->left))
    {
      _gtk_tree_rbtree_debug_spew_helper (tree, node->left, s, depth + 1);
    }
  if (!_gtk_tree_rbtree_is_nil (node->right))
    {
      _gtk_tree_rbtree_debug_spew_helper (tree, node->right, s, depth + 1);
    }
}

static void
_gtk_tree_rbtree_debug_spew (GtkTreeRBTree *tree, GString *s)
{
  g_return_if_fail (tree != NULL);
  ...
  if (_gtk_tree_rbtree_is_nil (tree->root))
    ...
    _gtk_tree_rbtree_debug_spew_helper (tree, tree->root, s, 0);
}
