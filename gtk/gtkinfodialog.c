 ...
 * should be modal.
 *
 * The dialog is shown with the [method@Gtk.InfoDialog.present]
 * function. This API follows the GIO async pattern, and the
 * result can be obtained by calling
 * [method@Gtk.InfoDialog.present_finish].
 *
...
gtk_info_dialog_class_init (GtkInfoDialogClass *class)
{
  ...
  /**
   * GtkInfoDialog:modal: (attributes org.gtk.Property.get=gtk_info_dialog_get_modal org.gtk.Property.set=gtk_info_dialog_set_modal)
   *
  ...
  /**
   * GtkInfoDialog:heading: (attributes org.gtk.Property.get=gtk_info_dialog_get_heading org.gtk.Property.set=gtk_info_dialog_set_heading)
   *
   * The heading for the dialog that is presented
   * by [method@Gtk.InfoDialog.present].
   *
   * Since: 4.10
   */
  ...
  /**
   * GtkInfoDialog:heading-use-markup: (attributes org.gtk.Property.get=gtk_info_dialog_get_heading_use_markup org.gtk.Property.set=gtk_info_dialog_set_heading_use_markup)
   *
  ...
  /**
   * GtkInfoDialog:body: (attributes org.gtk.Property.get=gtk_info_dialog_get_body org.gtk.Property.set=gtk_info_dialog_set_body)
   *
  ...
  /**
   * GtkInfoDialog:body-use-markup: (attributes org.gtk.Property.get=gtk_info_dialog_get_body_use_markup org.gtk.Property.set=gtk_info_dialog_set_body_use_markup)
   *
  ...
  /**
   * GtkInfoDialog:buttons: (attributes org.gtk.Property.get=gtk_info_dialog_get_buttons org.gtk.Property.set=gtk_info_dialog_set_buttons)
   *
 ...
 * It should call [method@Gtk.InfoDialog.present_finish]
 * to obtain the result. It is ok to pass `NULL` for the callback
 * if the dialog does not have any buttons to check on.
 *
 * Since: 4.10
 */
void
 ...
 *
 * Finishes the [method@Gtk.InfoDialog.present] call
                                ...
                                GError        **error)
{
  ...
  g_return_val_if_fail (g_task_get_source_tag (task) == gtk_info_dialog_present, FALSE);

  *button = (int) g_task_propagate_int (task, error);
  return !(error && *error);
}
