 ...
 *
 * For widgets that normally have a context menu,
 * such as entries, this will return the default
 * model. You can add items to it and set it back
 * using gtk_widget_set_context_menu().
 *
