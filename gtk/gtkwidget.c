...
G_DEFINE_TYPE_WITH_CODE (GtkWidgetClassActionGroup, gtk_widget_class_action_group, G_TYPE_OBJECT,
                         G_IMPLEMENT_INTERFACE (G_TYPE_ACTION_GROUP, gtk_widget_class_action_group_iface_init))
      ...
      if (!g_hash_table_contains (prefixes, prefix))
        {
          ...
          gtk_widget_insert_action_group (widget, prefix, gtk_widget_class_action_group_new (widget, prefix));
        }
    }
