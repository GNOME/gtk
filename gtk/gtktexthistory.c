              ...
              gboolean  in_user_action)
{
  ...
  switch (action->kind)
    ...
    do_chain:
      ...
      istring_append (&action->u.insert.istr,
                      istring_str (&other->u.insert.istr),
                      other->u.insert.istr.n_bytes,
                      other->u.insert.istr.n_chars);
      ...
      if (action->u.delete.begin == other->u.delete.begin)
        {
          if (!istring_contains_space (&other->u.delete.istr) ||
            ...
            {
              istring_append (&action->u.delete.istr,
                              istring_str (&other->u.delete.istr),
                              other->u.delete.istr.n_bytes,
                              other->u.delete.istr.n_chars);
