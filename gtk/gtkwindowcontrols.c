...
static void
surface_state_changed (GtkWindowControls *self)
{
  GtkNative *native;
  GdkSurface *surface;
...
static void
gtk_window_controls_realize (GtkWidget *widget)
{
  GtkSettings *settings;
  GtkWidget *root;

  GTK_WIDGET_CLASS (gtk_window_controls_parent_class)->realize (widget);
...
static void
gtk_window_controls_unrealize (GtkWidget *widget)
{
  GtkSettings *settings;
  ...
  GTK_WIDGET_CLASS (gtk_window_controls_parent_class)->unrealize (widget);
}
...
gtk_window_controls_class_init (GtkWindowControlsClass *klass)
{
  ...
  widget_class->realize = gtk_window_controls_realize;
  widget_class->unrealize = gtk_window_controls_unrealize;
