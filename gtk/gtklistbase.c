...
gtk_list_base_class_init (GtkListBaseClass *klass)
{
  ...
  gtk_binding_entry_add_action (binding_set, GDK_KEY_g, GDK_CONTROL_MASK, "list.next-match", "(b)", TRUE);
  gtk_binding_entry_add_action (binding_set, GDK_KEY_g, GDK_CONTROL_MASK | GDK_SHIFT_MASK, "list.next-match", "(b)", FALSE);
}
