...
static GdkTexture *
extract_texture (GskRenderNodeReplay *replay,
                 GskRenderNode       *node,
                 GdkTexture          *texture,
                 gpointer             user_data)
{
...
static PangoFont *
extract_font (GskRenderNodeReplay *replay,
              GskRenderNode       *node,
              PangoFont           *font,
              gpointer             user_data)
{
...
file_extract (const char *filename)
{
  ...
  gsk_render_node_replay_set_texture_filter (replay,
                                             extract_texture,
                                             basename,
                                             g_free);
  gsk_render_node_replay_set_font_filter (replay,
                                          extract_font,
                                          g_strdup (basename),
                                          g_free);
