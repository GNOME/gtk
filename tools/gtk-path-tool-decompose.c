...
{
  GError *error = NULL;
  gboolean allow_curves = FALSE;
  gboolean allow_conics = FALSE;
  char **args = NULL;
  GOptionContext *context;
  GOptionEntry entries[] = {
    { "allow-curves", 0, 0, G_OPTION_ARG_NONE, &allow_curves, N_("Allow curves"), NULL },
    { "allow-conics", 0, 0, G_OPTION_ARG_NONE, &allow_conics, N_("Allow conics"), NULL },
