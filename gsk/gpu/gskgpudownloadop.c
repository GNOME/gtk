                           ...
                           GdkMemoryLayout       *layout)
{
  ...
  for (i = 0; i < n_planes; i++)
    {
      gsize block_width = gdk_memory_format_get_block_width (layout->format, i);
      gsize block_height = gdk_memory_format_get_block_height (layout->format, i);
      gsize block_bytes = gdk_memory_format_get_block_bytes (layout->format, i);
