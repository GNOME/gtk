...
#if 0
static gboolean
gsk_d3d12_get_ycbcr_flags (GskGpuConversion               conv,
                                   ...
                                   GskGpuImageFlags  *out_flags)
{
  ...
  vk_phys_device = gsk_d3d12_device_get_vk_physical_device (device);
  ...
  res = vkGetPhysicalDeviceImageFormatProperties2 (vk_phys_device,
                                                   &(VkPhysicalDeviceImageFormatInfo2) {
                                                     ...
                                                     .pNext = (tiling != VK_IMAGE_TILING_DRM_FORMAT_MODIFIER_EXT) ? NULL : &(VkPhysicalDeviceImageDrmFormatModifierInfoEXT) {
                                                         ...
                                                         .pQueueFamilyIndices = (uint32_t[1]) { gsk_d3d12_device_get_vk_queue_family_index (device) },
                                                      }
                                                   },
                                                   &image_properties);
  if (res != VK_SUCCESS)
  ...
  *out_flags = 0;
  ...
  if (image_properties.imageFormatProperties.maxMipLevels >= gsk_d3d12_mipmap_levels (width, height) &&
...
static void
gsk_d3d12_image_create_view (GskD3d12Image            *self,
                              VkFormat                   vk_format,
                              const VkComponentMapping  *vk_components,
                              VkSamplerYcbcrConversion   vk_conversion)
{
  GSK_VK_CHECK (vkCreateImageView, gsk_d3d12_device_get_vk_device (self->device),
...
static gboolean
gsk_d3d12_device_check_format (GskD3d12Device          *device,
                                VkFormat                  vk_format,
                                const VkComponentMapping *vk_components,
...
#define CHECK_FLAGS (GSK_GPU_IMAGE_BLIT | GSK_GPU_IMAGE_FILTERABLE | GSK_GPU_IMAGE_RENDERABLE | GSK_GPU_IMAGE_CAN_MIPMAP)
  ...
  if (gsk_d3d12_device_supports_format (device,
                                         vk_format,
                                         0, 1,
                                         vk_tiling, vk_usage,
                                         width, height,
  ...
  if (vk_tiling == VK_IMAGE_TILING_LINEAR &&
      gsk_d3d12_device_supports_format (device,
                                         vk_format,
                                         0, 1,
...
static gboolean
gsk_d3d12_device_supports_conversion (GskD3d12Device *device,
                                       GskGpuConversion conv)
{
  switch (conv)
    ...
    case GSK_GPU_CONVERSION_BT2020:
    case GSK_GPU_CONVERSION_BT2020_NARROW:
      if (!gsk_d3d12_device_has_feature (device, GDK_D3D12_FEATURE_YCBCR))
        return FALSE;
      break;
                      ...
                      VkMemoryPropertyFlags      memory)
{
  ...
  if (!gsk_d3d12_device_supports_conversion (device, conv))
  ...
  if (gsk_d3d12_device_check_format (device, vk_srgb_format, &vk_components, required_flags,
                                      tiling, usage, width, height,
                                      &tiling, &flags))
    {
      vk_format = vk_srgb_format;
    }
  else if (!gsk_d3d12_device_check_format (device, vk_format, &vk_components, required_flags,
                                            tiling, usage, width, height,
                                            &tiling, &flags))
    {
  ...
  vk_device = gsk_d3d12_device_get_vk_device (device);
  ...
  if (gsk_d3d12_get_ycbcr_flags (conv, &vk_model, &vk_range) || needs_conversion)
    {
      self->ycbcr = gsk_d3d12_device_get_ycbcr (device,
                                                 &(GskD3d12YcbcrInfo) {
                                                     .vk_format = vk_format,
      ...
      gsk_d3d12_ycbcr_ref (self->ycbcr);
      vk_conversion = gsk_d3d12_ycbcr_get_vk_conversion (self->ycbcr);
  ...
  GSK_VK_CHECK (vkCreateImage, vk_device,
                                &(VkImageCreateInfo) {
                                    ...
                                    .mipLevels = (flags & GSK_GPU_IMAGE_CAN_MIPMAP) ? gsk_d3d12_mipmap_levels (width, height) : 1,
                                    .arrayLayers = 1,
  ...
  memory_index = gsk_d3d12_device_find_allocator (device,
                                                   requirements.memoryTypeBits,
                                                   0,
                                                   tiling == VK_IMAGE_TILING_LINEAR ? GSK_D3D12_MEMORY_MAPPABLE : 0);
  self->allocator = gsk_d3d12_device_get_allocator (device, memory_index);
  gsk_d3d12_allocator_ref (self->allocator);

  gsk_d3d12_alloc (self->allocator,
                    requirements.size,
  ...
  gsk_d3d12_image_create_view (self, vk_format, &vk_components, vk_conversion);
...
#if 0
GskGpuImage *
gsk_d3d12_image_new_for_upload (GskD3d12Device *device,
                                 ...
                                 gsize            height)
{
  ...
  self = gsk_d3d12_image_new (device,
                               format,
                               conv,
...
static gboolean
gsk_d3d12_image_can_map (GskD3d12Image *self)
{
...
GskGpuImage *
gsk_d3d12_image_new_for_swapchain (GskD3d12Device  *device,
                                    VkImage           image,
                                    VkFormat          format,
                                    ...
                                    gsize             height)
{
  ...
  gsk_d3d12_image_create_view (self,
                                format,
                                &(VkComponentMapping) {
...
GskGpuImage *
gsk_d3d12_image_new_for_atlas (GskD3d12Device *device,
                                gsize            width,
                                gsize            height)
{
  GskD3d12Image *self;
...
GskGpuImage *
gsk_d3d12_image_new_for_offscreen (GskD3d12Device *device,
                                    gboolean         with_mipmap,
...
#ifdef HAVE_DMABUF
static gboolean
gsk_d3d12_device_check_dmabuf_format (GskD3d12Device          *device,
                                       VkFormat                  vk_format,
                                       const VkComponentMapping *vk_components,
                                       gsize                     width,
                                       gsize                     height,
...
GskGpuImage *
gsk_d3d12_image_new_dmabuf (GskD3d12Device *device,
                             GdkMemoryFormat  format,
                             gboolean         try_srgb,
                             gsize            width,
                             gsize            height)
{
  ...
  if (!gdk_has_feature (GDK_FEATURE_DMABUF) ||
      !gsk_d3d12_device_has_feature (device, GDK_D3D12_FEATURE_DMABUF))
    return NULL;
  ...
  if (try_srgb)
    vk_srgb_format = gdk_memory_format_vk_srgb_format (format);
  if (gsk_d3d12_device_check_dmabuf_format (device, vk_srgb_format, &vk_components, width, height,
                                             modifiers, &flags, &n_modifiers))
    {
      vk_format = vk_srgb_format;
    }
  else if (!gsk_d3d12_device_check_dmabuf_format (device, vk_format, &vk_components, width, height,
                                                   modifiers, &flags, &n_modifiers))
    {
  ...
  if (res != VK_SUCCESS)
    {
      gsk_d3d12_handle_result (res, "vkCreateImage");
      return NULL;
    }
  ...
  memory_index = gsk_d3d12_device_find_allocator (device,
                                                   ...
                                                   0,
                                                   VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
  self->allocator = gsk_d3d12_device_get_external_allocator (device);
  gsk_d3d12_allocator_ref (self->allocator);
...
GskGpuImage *
gsk_d3d12_image_new_for_dmabuf (GskD3d12Device *device,
                                 gsize            width,
                                 gsize            height,
                                 ...
                                 GskGpuConversion conv)
{
  ...
  if (!gsk_d3d12_device_has_feature (device, GDK_D3D12_FEATURE_DMABUF))
    {
      GDK_DEBUG (DMABUF, "D3d12 does not support dmabufs");
      return NULL;
    }
  ...
  if (gdk_memory_format_find_by_dmabuf_fourcc (dmabuf->fourcc, premultiplied, &format, &is_yuv))
    ...
    {
      GDK_DEBUG (DMABUF, "GTK's D3d12 doesn't support fourcc %.4s", (char *) &dmabuf->fourcc);
      return NULL;
    }
  ...
  if (gdk_dmabuf_is_disjoint (dmabuf))
    {
      GDK_DEBUG (DMABUF, "FIXME: Add support for disjoint dmabufs to D3d12");
      return NULL;
    }
  ...
  if (!gsk_d3d12_device_supports_format (device,
                                          ...
                                          &flags))
    {
      GDK_DEBUG (DMABUF, "D3d12 driver does not support format %.4s::%016llx with %u planes",
  ...
  if (res != VK_SUCCESS)
    {
      GDK_DEBUG (DMABUF, "vkCreateImage() failed: %s", gdk_d3d12_strerror (res));
      return NULL;
    }
  ...
  if (gsk_d3d12_get_ycbcr_flags (conv, &model, &range) || needs_conversion)
    {
      self->ycbcr = gsk_d3d12_device_get_ycbcr (device,
                                                 &(GskD3d12YcbcrInfo) {
                                                     .vk_format = vk_format,
  ...
  if (fd < 0)
    {
      GDK_DEBUG (DMABUF, "D3d12 failed to dup() fd: %s", g_strerror (errno));
  ...
  for (i = 0; i < 1 /* disjoint ? dmabuf->n_planes : 1 */; i++)
    {
      ...
      if (gsk_d3d12_device_has_feature (device, GDK_D3D12_FEATURE_SEMAPHORE_IMPORT))
        {
...
#if 1
  GSK_VK_CHECK (vkBindImageMemory2, gsk_d3d12_device_get_vk_device (self->device),
                                    1,
  ...
  GDK_DEBUG (DMABUF, "D3d12 uploaded %zux%zu %.4s:%016llx %sdmabuf",
             width, height,
...
static guint
gsk_d3d12_image_get_n_planes (GskD3d12Image *self,
                               guint64         modifier)
{
  VkDrmFormatModifierPropertiesEXT drm_mod_properties[100];
  VkDrmFormatModifierPropertiesListEXT drm_properties = {
  ...
  vkGetPhysicalDeviceFormatProperties2 (gsk_d3d12_device_get_vk_physical_device (self->device),
                                        self->vk_format,
                                        &properties);
...
GdkTexture *
gsk_d3d12_image_to_dmabuf_texture (GskD3d12Image *self,
                                    GdkColorState  *color_state)
{
  ...
  vk_device = gsk_d3d12_device_get_vk_device (self->device);
  ...
  if (res != VK_SUCCESS)
    return FALSE;
  n_planes = gsk_d3d12_image_get_n_planes (self, properties.drmFormatModifier);
  ...
  if (texture == NULL)
    {
      GDK_DEBUG (D3D12, "Failed to create dmabuf texture: %s", error->message);
      g_clear_error (&error);
      close (fd);
      return NULL;
    }
...
static gboolean
gsk_d3d12_is_same_device (VkDevice           vk_device,
...
GskGpuImage *
gsk_d3d12_image_new_for_d3d12resource (GskD3d12Device *device,
                                        ID3D12Resource  *resource,
                                        ...
                                        gboolean         premultiplied)
{
  ...
  if (!gsk_d3d12_device_has_feature (device, GDK_D3D12_FEATURE_WIN32))
    {
      GDK_DEBUG (D3D12, "D3d12 does not support D3D12Resource import");
      return NULL;
    }
  ...
  if (!gsk_d3d12_is_same_device (vk_device, (ID3D12DeviceChild *) resource))
    {
  ...
  if (vk_format == VK_FORMAT_UNDEFINED)
    {
      GDK_DEBUG (D3D12, "GTK's D3d12 doesn't support DXGI format %u", desc.Format);
      return NULL;
    }

  if (needs_conversion && !gsk_d3d12_device_has_feature (device, GDK_D3D12_FEATURE_YCBCR))
    {
      GDK_DEBUG (D3D12, "D3d12 driver cannot import DXGI format %u because it lacks YCbCr support", desc.Format);
      return NULL;
    }
  ...
  if (!gsk_d3d12_device_supports_format (device,
                                          ...
                                          &flags))
    {
      GDK_DEBUG (D3D12, "D3d12 driver does not support DXGI format %u", desc.Format);
      return NULL;
    }
  ...
  if (res != VK_SUCCESS)
    {
      GDK_DEBUG (D3D12, "vkCreateImage() failed: %s", gdk_d3d12_strerror (res));
      return NULL;
    }
  ...
  if (gsk_d3d12_device_has_feature (device, GDK_D3D12_FEATURE_WIN32_SEMAPHORE) && fence)
    {
  ...
  GDK_DEBUG (D3D12, "D3d12 uploaded %ux%u resource of %sformat %u",
...
#if 0
VkFramebuffer
gsk_d3d12_image_get_vk_framebuffer (GskD3d12Image *self,
...
VkDescriptorSet
gsk_d3d12_image_get_vk_descriptor_set (GskD3d12Image *self,
                                        GskGpuSampler   sampler)
{
  if (!self->descriptor_sets[sampler].vk_descriptor_set)
    {
      self->descriptor_sets[sampler].vk_descriptor_set =
        gsk_d3d12_device_allocate_descriptor (self->device,
                                               self->ycbcr ? gsk_d3d12_ycbcr_get_vk_descriptor_set_layout (self->ycbcr)
                                                           : gsk_d3d12_device_get_vk_image_set_layout (self->device),
                                               &self->descriptor_sets[sampler].pool_id);

      vkUpdateDescriptorSets (gsk_d3d12_device_get_vk_device (self->device),
                              1,
                              &(VkWriteDescriptorSet) {
                                  ...
                                  .pImageInfo = &(VkDescriptorImageInfo) {
                                      .sampler = self->ycbcr ? gsk_d3d12_ycbcr_get_vk_sampler (self->ycbcr)
                                                             : gsk_d3d12_device_get_vk_sampler (self->device, sampler),
...
GskD3d12Ycbcr *
gsk_d3d12_image_get_ycbcr (GskD3d12Image *self)
{
  return self->ycbcr;
}

VkImage
gsk_d3d12_image_get_vk_image (GskD3d12Image *self)
{
  return self->vk_image;
}

VkImageView
gsk_d3d12_image_get_vk_image_view (GskD3d12Image *self)
{
  return self->vk_image_view;
}

VkPipelineStageFlags
gsk_d3d12_image_get_vk_pipeline_stage (GskD3d12Image *self)
{
  return self->vk_pipeline_stage;
}

VkImageLayout
gsk_d3d12_image_get_vk_image_layout (GskD3d12Image *self)
{
  return self->vk_image_layout;
}

VkAccessFlags
gsk_d3d12_image_get_vk_access (GskD3d12Image *self)
{
  return self->vk_access;
}

void
gsk_d3d12_image_set_vk_image_layout (GskD3d12Image       *self,
                                      VkPipelineStageFlags  stage,
                             ...
                             VkAccessFlags         access)
{
  ...
  gsk_d3d12_image_set_vk_image_layout (self, stage, image_layout, access);
}

VkFormat
gsk_d3d12_image_get_vk_format (GskD3d12Image *self)
{
