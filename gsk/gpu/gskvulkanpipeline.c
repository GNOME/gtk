                         ...
                         VkRenderPass               render_pass)
{
  ...
  result->vk_vertex_shader = gsk_vulkan_pipeline_create_vk_shader_module (display, vertex_shader_name);
  result->vk_fragment_shader = gsk_vulkan_pipeline_create_vk_shader_module (display, fragment_shader_name);
