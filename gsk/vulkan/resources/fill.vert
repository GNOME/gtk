...
layout(location = 4) in int in_n_points;
layout(location = 5) in int in_fill_rule;
...
layout(location = 5) out flat int out_n_points;
layout(location = 6) out flat int out_fill_rule;
