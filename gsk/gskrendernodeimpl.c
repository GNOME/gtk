...
{
  gsk_render_node_types[GSK_CONTAINER_NODE] = gsk_container_node_get_type ();
  gsk_render_node_types[GSK_CAIRO_NODE] = gsk_cairo_node_get_type ();
...
G_GNUC_END_IGNORE_DEPRECATIONS
  gsk_render_node_types[GSK_DEBUG_NODE] = gsk_debug_node_get_type ();
