...
static void
gsk_container_node_foreach (GskRenderNode   *node,
                                   ...
                                   const GSList    *copies)
{
  ...
  for (i = 0; i < self->n_children; i++)
    {
      gsk_render_node_render_opacity (self->children[i], renderer, copies);
    }
}
                               ...
                               gpointer class_data)
{
  ...
  node_class->foreach = gsk_container_node_foreach;
