                                    ...
                                    gsize            height)
{
  ...
  self->size = self->planes[dmabuf->n_planes - 1].offset + 
               (self->height - 1) / gdk_memory_format_get_block_height (self->format, dmabuf->n_planes - 1)
                                  * self->planes[dmabuf->n_planes - 1].stride +
               self->width / gdk_memory_format_get_block_width (self->format, dmabuf->n_planes - 1)
                           * gdk_memory_format_get_block_bytes (self->format, dmabuf->n_planes - 1);
