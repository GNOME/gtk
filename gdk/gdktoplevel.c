...
/**
 * gdk_toplevel_begin_resize_drag:
 * @toplevel: a #GdkToplevel
 ...
 */
void
gdk_toplevel_begin_resize_drag (GdkToplevel    *toplevel,
                                GdkSurfaceEdge  edge,
                                GdkDevice      *device,
                                int             button,
                                double          x,
                                ...
                                guint32         timestamp)
{
  ...
  GDK_TOPLEVEL_GET_IFACE (toplevel)->begin_resize_drag (toplevel,
                                                        edge,
                                                        device,
                                                        button,
                                                        x, y,
 ...
 */
void
gdk_toplevel_begin_move_drag (GdkToplevel *toplevel,
                              GdkDevice   *device,
                              int          button,
                              double       x,
                              double       y,
                              guint32      timestamp)
{
  ...
  GDK_TOPLEVEL_GET_IFACE (toplevel)->begin_move_drag (toplevel,
                                                      device,
                                                      button,
                                                      x, y,
                                                      timestamp);
