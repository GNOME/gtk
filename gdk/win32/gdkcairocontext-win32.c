...
static void
gdk_win32_cairo_context_ensure_swap_chain (GdkWin32CairoContext *self)
{
  GdkDrawContext *context = GDK_DRAW_CONTEXT (self);
                                     ...
                                     GdkMemoryDepth  *out_depth)
{
  ...
  gdk_win32_cairo_context_ensure_swap_chain (self);
...
static void
gdk_win32_cairo_context_dispose (GObject *object)
{
  ...
  G_OBJECT_CLASS (gdk_win32_cairo_context_parent_class)->dispose (object);
}
...
gdk_win32_cairo_context_class_init (GdkWin32CairoContextClass *klass)
{
  ...
  object_class->dispose = gdk_win32_cairo_context_dispose;
}
