  ...
  if (update_geometry)
    {
      ...
      if (gdk_toplevel_layout_get_maximized (layout, &is_maximized) && is_maximized && monitor) 
        {
          geometry.min_width = bounds_width;
          geometry.min_height = bounds_height;
          mask = GDK_HINT_MIN_SIZE;
      } else if (gdk_toplevel_layout_get_fullscreen (layout, &is_fullscreened) && is_fullscreened && monitor) 
        {
