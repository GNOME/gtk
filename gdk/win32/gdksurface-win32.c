...
static void
gdk_win32_toplevel_begin_resize_drag (GdkToplevel    *toplevel,
                                      GdkSurfaceEdge  edge,
                                      GdkDevice      *device,
                                      int             button,
                                      double          x,
...
static void
gdk_win32_toplevel_begin_move_drag (GdkToplevel *toplevel,
                                    GdkDevice   *device,
                                    int          button,
                                    double       x,
                                    double       y,
...
gdk_win32_toplevel_iface_init (GdkToplevelInterface *iface)
{
  ...
  iface->begin_resize_drag = gdk_win32_toplevel_begin_resize_drag;
  iface->begin_move_drag = gdk_win32_toplevel_begin_move_drag;
}
