...
DECLARE_INTERFACE_(IDWriteLocalFontFileLoader,IDWriteFontFileLoader)
{
    ...
    /* IDWriteFontFileLoader methods */
    STDMETHOD(CreateStreamFromKey)(THIS_ void const *fontFileReferenceKey,
        UINT32 fontFileReferenceKeySize,
        IDWriteFontFileStream **fontFileStream) PURE;
#endif

    /* IDWriteLocalFontFileLoader methods */
    STDMETHOD(GetFilePathLengthFromKey)(THIS_ void const* fontFileReferenceKey,
        UINT32 fontFileReferenceKeySize,
        UINT32* filePathLength
        ) PURE;

    STDMETHOD(GetFilePathFromKey)(THIS_ void const* fontFileReferenceKey,
        UINT32 fontFileReferenceKeySize,
        WCHAR* filePath,
        UINT32 filePathSize
        ) PURE;

    STDMETHOD(GetLastWriteTimeFromKey)(THIS_ void const* fontFileReferenceKey,
        UINT32 fontFileReferenceKeySize,
...
#define IDWriteLocalFontFileLoader_CreateStreamFromKey(This,key,keysize,stream) (This)->lpVtbl->CreateStreamFromKey(This, key, keysize, stream)
#define IDWriteLocalFontFileLoader_GetFilePathLengthFromKey(This,key,keysize,pathlength) (This)->lpVtbl->GetFilePathLengthFromKey(This, key, keysize, pathlength)
#define IDWriteLocalFontFileLoader_GetFilePathFromKey(This,key,keysize,path,pathsize) (This)->lpVtbl->GetFilePathFromKey(This, key, keysize, path, pathsize)
#define IDWriteLocalFontFileLoader_GetLastWriteTimeFromKey(This,key,keysize,lastime) (This)->lpVtbl->GetLastWriteTimeFromKey(This, key, keysize, lastime)
#endif
