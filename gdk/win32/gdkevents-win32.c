                                 ...
                                 gboolean   *return_val)
{
  ...
  switch (msg->message)
    ...
    case WM_INPUTLANGCHANGE:
        ...
        gdk_win32_display_set_input_locale (display_win32, input_locale);
        _gdk_win32_keymap_set_active_layout (win32_keymap, input_locale);
        gdk_win32_display_increment_keymap_serial (display_win32);
        GDK_NOTE (EVENTS,
                  g_print (" cs:%lu hkl:%p%s",
                           (gulong) msg->wParam,
                           (gpointer) msg->lParam,
                           gdk_win32_display_input_locale_is_ime (display_win32) ? " (IME)" : ""));
