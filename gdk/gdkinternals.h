...
typedef enum
{
  ...
  /* The key event is generated by an input method engine or processed
   * by the engine with an async thread and this flag can prevent
   * #GtkIMContext from forwarding the event to the engine again.
   */
  GDK_EVENT_INPUT_METHOD = 1 << 3
} GdkEventFlags;
