                        ...
                        gsize            stride)
{
  ...
  g_return_val_if_fail (width % gdk_memory_format_get_block_width (format, 0) == 0, NULL);
  g_return_val_if_fail (height % gdk_memory_format_get_block_height (format, 0) == 0, NULL);
