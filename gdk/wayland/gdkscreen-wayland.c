...
static gboolean
monitor_should_update_screen (GdkWaylandMonitor *monitor)
{
                        ...
                        int32_t           transform)
{
  ...
  if (monitor_should_update_screen (monitor) || !monitor_has_xdg_output (monitor))
    apply_monitor_change (monitor);
}
                     ...
                     int32_t           scale)
{
  ...
  if (monitor_should_update_screen (monitor))
    apply_monitor_change (monitor);
}
