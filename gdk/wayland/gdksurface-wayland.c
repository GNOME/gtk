...
static void
gdk_wayland_toplevel_begin_resize_drag (GdkToplevel    *toplevel,
                                        GdkSurfaceEdge  edge,
                                        GdkDevice      *device,
                                        int             button,
                                        double          x,
                                        ...
                                        guint32         timestamp)
{
  ...
  switch (edge)
    ...
    default:
      g_warning ("gdk_toplevel_begin_resize_drag: bad resize edge %d!", edge);
      return;
    }
...
static void
gdk_wayland_toplevel_begin_move_drag (GdkToplevel *toplevel,
                                      GdkDevice   *device,
                                      int          button,
                                      double       x,
                                      double       y,
...
gdk_wayland_toplevel_iface_init (GdkToplevelInterface *iface)
{
  ...
  iface->begin_resize_drag = gdk_wayland_toplevel_begin_resize_drag;
  iface->begin_move_drag = gdk_wayland_toplevel_begin_move_drag;
}
