...
guint32 gdk_event_interpolation_latest_event_time (GdkEventInterpolation  *interpolator);
...
guint32 gdk_event_interpolation_latest_event_time_before (GdkEventInterpolation  *interpolator,
                                                          guint32                 interval);
