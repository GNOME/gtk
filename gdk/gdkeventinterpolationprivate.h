...
guint32 gdk_absolute_event_interpolation_latest_event_time (GdkAbsoluteEventInterpolation  *interpolator);

guint32 gdk_absolute_event_interpolation_latest_event_time_before (GdkAbsoluteEventInterpolation  *interpolator,
                                                                   guint32                         interval);

void gdk_absolute_event_interpolation_received_stop (GdkAbsoluteEventInterpolation  *interpolator,
                                                     GdkEvent                       *event);

GdkEvent * gdk_absolute_event_interpolation_get_stop_event (GdkAbsoluteEventInterpolation  *interpolator);

guint32 gdk_absolute_event_interpolation_average_event_interval (GdkAbsoluteEventInterpolation  *interpolator);
...
guint32 gdk_relative_event_interpolation_latest_event_time (GdkRelativeEventInterpolation  *interpolator);

void gdk_relative_event_interpolation_received_stop (GdkRelativeEventInterpolation  *interpolator,
                                                     GdkEvent *event);

GdkEvent * gdk_relative_event_interpolation_get_stop_event (GdkRelativeEventInterpolation  *interpolator);

guint32 gdk_relative_event_interpolation_latest_event_time_before (GdkRelativeEventInterpolation  *interpolator,
                                                                   guint32                         interval);

guint32 gdk_relative_event_interpolation_average_event_interval (GdkRelativeEventInterpolation  *interpolator);
