 ...
 * @self: the downloader
 * @out_offsets: (out) (array length=4): The offsets of the resulting data planes in bytes
 * @out_strides: (out) (array length=4): The stride of the resulting data planes in bytes
 *
