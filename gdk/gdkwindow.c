  ...
  if (gdk_event_interpolation_history_length (animating_interpolator) > 0)
    {
      ...
      guint32 timestamp_offset_from_newest_event = (frame_time / 1000) -
      ...
      window->interpolation_time_offset = timestamp_offset_from_newest_event;
                                               ...
                                               gint64     frame_time)
{
  ...
  /* Calculate the time delta between the upcoming frame and the time the
     newest event was received. frame_time can sometimes get wacky - it
