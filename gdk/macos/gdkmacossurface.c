...
void
gdk_macos_surface_frame_presented (GdkDrawContextFrame *frame,
                                ...
                                GdkDrawContextFrame *frame)
{
  ...
  mac_frame->monitor = self->best_monitor;
  gdk_macos_monitor_add_frame_callback (GDK_MACOS_MONITOR (mac_frame->monitor), mac_frame);
                                  ...
                                  GdkDrawContextFrame *frame)
{
  ...
  if (mac_frame->monitor)
    gdk_macos_monitor_remove_frame_callback (GDK_MACOS_MONITOR (mac_frame->monitor), mac_frame);
...
gdk_macos_surface_class_init (GdkMacosSurfaceClass *klass)
{
  ...
  surface_class->frame_size = sizeof (GdkMacosSurfaceFrame);
