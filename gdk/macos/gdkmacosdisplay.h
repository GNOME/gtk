...
#define GDK_MACOS_DISPLAY_CLASS(klass)      (G_TYPE_CHECK_CLASS_CAST ((klass), GDK_TYPE_MACOS_DISPLAY, GdkMacosDisplayClass))
#define GDK_IS_MACOS_DISPLAY(object)        (G_TYPE_CHECK_INSTANCE_TYPE ((object), GDK_TYPE_MACOS_DISPLAY))
#define GDK_IS_MACOS_DISPLAY_CLASS(klass)   (G_TYPE_CHECK_CLASS_TYPE ((klass), GDK_TYPE_MACOS_DISPLAY))
#define GDK_MACOS_DISPLAY_GET_CLASS(obj)    (G_TYPE_INSTANCE_GET_CLASS ((obj), GDK_TYPE_MACOS_DISPLAY, GdkMacosDisplayClass))
