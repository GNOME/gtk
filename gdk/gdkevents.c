    ...
    case GDK_TOUCHPAD_PINCH:
      {
        ...
        scale_name = &g_array_index (names, char *, 0);
        *scale_name = "scale";
    ...
    case GDK_TOUCHPAD_PINCH:
      {
        ...
        scale = &g_array_index (values, gdouble, 0);
      ...
      if (event->scroll.direction == GDK_SCROLL_SMOOTH)
        {
          ...
          dx_name = &g_array_index (names, char *, 0);
          dy_name = &g_array_index (names, char *, 1);
    ...
    case GDK_TOUCHPAD_PINCH:
      {
        char **dx_name;
        char **dy_name;
        char **angle_delta_name;

        g_array_set_size (names, 3);

        dx_name = &g_array_index (names, char *, 0);
        dy_name = &g_array_index (names, char *, 1);
        angle_delta_name = &g_array_index (names, char *, 2);

        *dx_name = "dx";
        *dy_name = "dy";
        *angle_delta_name = "angle_delta";
 ...
 * @values: (out caller-allocates): array to hold returned values
 *
 * Extract the values of the event relative properties intended for interpolation.
 *
 * Returns: %TRUE if the event delivered properties for interpolation
 */
gboolean
      ...
      if (event->scroll.direction == GDK_SCROLL_SMOOTH)
        {
          ...
          dx = &g_array_index (values, gdouble, 0);
          dy = &g_array_index (values, gdouble, 1);
    ...
    case GDK_TOUCHPAD_PINCH:
      {
        ...
        dx = &g_array_index (values, gdouble, 0);
        dy = &g_array_index (values, gdouble, 1);
        angle_delta = &g_array_index (values, gdouble, 2);

        *dx = event->touchpad_pinch.dx;
        *dy = event->touchpad_pinch.dy;
        *angle_delta = event->touchpad_pinch.angle_delta;
