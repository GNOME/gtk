                                    ...
                                    GdkMemoryDepth      *out_depth)
{
  ...
  GDK_DRAW_CONTEXT_CLASS (gdk_android_gl_context_parent_class)->begin_frame (draw_context, frame, context_data, region, out_color_state, out_depth);
}
                                  ...
                                  cairo_region_t      *painted)
{
  ...
  GDK_DRAW_CONTEXT_CLASS (gdk_android_gl_context_parent_class)->end_frame (draw_context, frame, context_data, painted);
}
