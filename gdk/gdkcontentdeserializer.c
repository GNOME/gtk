                                 ...
                                 gpointer      deserializer)
{
  ...
  *secret = '\0';
  ...
  file_transfer_portal_retrieve_files (session, secret, portal_finish, deserializer);
  gdk_content_deserializer_set_task_data (deserializer, str, g_free);
}
...
init (void)
{
  ...
  gdk_content_register_deserializer ("application/vnd.flatpak.file-list",
                                     GDK_TYPE_FILE_LIST,
