...
static gboolean gdk_x11_toplevel_handle_surface_event (GdkSurface *surface,
                                                       GdkEvent   *event,
                                                       gpointer    data);
  ...
  if (!impl->toplevel)
    {
      ...
      impl->toplevel->event_handler_id =
        g_signal_connect (surface, "event",
                          G_CALLBACK (gdk_x11_toplevel_handle_surface_event),
                          NULL);
    }
...
gdk_x11_surface_finalize (GObject *object)
{
  ...
  g_signal_handler_disconnect (GDK_SURFACE (impl),
                               impl->toplevel->event_handler_id);
...
static gboolean
gdk_x11_toplevel_handle_surface_event (GdkSurface *surface,
                                       GdkEvent   *event,
                                       gpointer    data)
{
