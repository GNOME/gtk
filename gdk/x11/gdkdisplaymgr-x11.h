...
extern "C"
{
  ...
  GdkDisplay *gdk_x11_display_manager_open_display (GdkDisplayManager *
						    dpy_mgr,
						    gchar * display_name);
  void gdk_x11_display_manager_set_default (GdkDisplayManager * dpy_mgr,
					    GdkDisplay * default_display);
  GdkDisplay *gdk_x11_display_manager_get_default (GdkDisplayManager *
						   dpy_mgr);
  gint gdk_x11_display_manager_get_display_count (GdkDisplayManager * dpy_mgr);
  GdkScreen *gdk_x11_display_manager_get_screen_for_root (GdkDisplayManager *
							  dpy_mgr,
							  Window root);
  GdkDisplay *gdk_x11_display_manager_get_display (GdkDisplayManager *
						   dpy_mgr, Display * dpy);
