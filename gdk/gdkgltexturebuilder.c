                                     ...
                                     GParamSpec   *pspec)
{
  ...
  switch (property_id)
    ...
    case PROP_HDR_METADATA:
      gdk_gl_texture_builder_set_hdr_metadata (self, g_value_get_boxed (value));
      break;
...
gdk_gl_texture_builder_class_init (GdkGLTextureBuilderClass *klass)
{
  ...
  /**
   * GdkGLTextureBuilder:hdr-metadata:
   *
...
/**
 * gdk_gl_texture_builder_get_hdr_metadata:
 * @self: a `GdkGLTextureBuilder`
 *
 * Gets the HDR metadata previously set via gdk_gl_texture_builder_set_hdr_metadata().
 *
 ...
 */
GdkHdrMetadata *
gdk_gl_texture_builder_get_hdr_metadata (GdkGLTextureBuilder *self)
{
  g_return_val_if_fail (GDK_IS_GL_TEXTURE_BUILDER (self), NULL);
...
/**
 * gdk_gl_texture_builder_set_hdr_metadata:
 * @self: a `GdkGLTextureBuilder`
 ...
 */
void
gdk_gl_texture_builder_set_hdr_metadata (GdkGLTextureBuilder *self,
                                         GdkHdrMetadata      *hdr_metadata)
{
  g_return_if_fail (GDK_IS_GL_TEXTURE_BUILDER (self));
