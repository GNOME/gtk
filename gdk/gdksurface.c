...
gboolean
gdk_surface_finish_relayout_helper (GdkSurface   *surface,
                                    GdkRectangle *out_flipped_rect,
                                    ...
                                    int          *out_flipped_y)
{
  ...
  if (out_flipped_rect)
    *out_flipped_rect = flipped_rect;
  if (out_final_rect)
    *out_final_rect = final_rect;
  if (out_flipped_x)
    *out_flipped_x = flipped_x;
  if (out_flipped_y)
    *out_flipped_y = flipped_y;
 ...
 *
 * Connect to the #GdkSurface::relayout-finished signal to find out how it was
 * laid out.
 */
void
...
gboolean
gdk_surface_finish_relayout (GdkSurface   *surface,
                             GdkRectangle *flipped_rect,
                             GdkRectangle *final_rect,
                             int          *flipped_x,
                             int          *flipped_y)
{
  g_return_val_if_fail (GDK_IS_SURFACE (surface), FALSE);
  g_return_val_if_fail (surface->parent || surface->transient_for, FALSE);
  g_return_val_if_fail (!GDK_SURFACE_DESTROYED (surface), FALSE);

  return GDK_SURFACE_GET_CLASS (surface)->finish_relayout (surface,
                                                           flipped_rect,
                                                           final_rect,
                                                           flipped_x,
                                                           flipped_y);
