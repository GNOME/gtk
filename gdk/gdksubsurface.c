                       ...
                       GdkSubsurface         *sibling)
{
  ...
  g_return_val_if_fail (source != NULL &&
                        gsk_rect_contains_rect (&GRAPHENE_RECT_INIT (0, 0,
                                                                     gdk_dihedral_flips_xy (transform) ? gdk_texture_get_height (texture) : gdk_texture_get_width (texture),
                                                                     gdk_dihedral_flips_xy (transform) ? gdk_texture_get_width (texture) : gdk_texture_get_height (texture)),
                                                source), FALSE);
