...
gdk_quartz_screen_calculate_layout (GdkQuartzScreen *screen)
{
  ...
  int max_x, max_y;
  CGSize main_display_size;

  screen->width = 0;
  screen->height = 0;
  screen->min_x = 0;
  screen->min_y = 0;
  screen->main_display_origin_x = 0;
  screen->main_display_origin_y = 0;
  max_x = max_y = 0;
  screen->mm_width = 0;
  screen->mm_height = 0;
  ...
  screen->main_display_origin_x = -screen->min_x;
  screen->main_display_origin_y = -screen->min_y + main_display_size.height;
  g_free (displays);
}
