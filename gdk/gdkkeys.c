 ...
 * at the end, and between any two sets of aliases. Place
 * the default key name at end of a set, to assure it is
 * handled last, giving it priority e.g. in menu shortcuts.
 */
static const guint aliases[] = {
  0,
  GDK_KEY_KP_Space, GDK_KEY_space,
  0,
  GDK_KEY_ISO_Left_Tab, GDK_KEY_KP_Tab, GDK_KEY_Tab,
  0,
  GDK_KEY_ISO_Enter, GDK_KEY_KP_Enter, GDK_KEY_Return,
  0,
  GDK_KEY_KP_Home, GDK_KEY_Home,
  0,
  GDK_KEY_KP_End, GDK_KEY_End,
  0,
  GDK_KEY_KP_Left, GDK_KEY_Left,
  0,
  GDK_KEY_KP_Up, GDK_KEY_Up,
  0,
  GDK_KEY_KP_Right, GDK_KEY_Right,
  0,
  GDK_KEY_KP_Down, GDK_KEY_Down,
  0,
  GDK_KEY_KP_Page_Up, GDK_KEY_Page_Up,
  0,
  GDK_KEY_KP_Page_Down, GDK_KEY_Page_Down,
  0,
  GDK_KEY_KP_Prior, GDK_KEY_Prior,
  0,
  GDK_KEY_KP_Next, GDK_KEY_Next,
  0,
  GDK_KEY_KP_Insert, GDK_KEY_Insert,
  0,
  GDK_KEY_KP_Delete, GDK_KEY_Delete,
  0,
  GDK_KEY_KP_Equal, GDK_KEY_equal,
  0,
  GDK_KEY_KP_Add, GDK_KEY_plus,
  0,
  GDK_KEY_KP_Subtract, GDK_KEY_minus,
  0,
  GDK_KEY_KP_Multiply, GDK_KEY_asterisk,
  0,
  GDK_KEY_KP_Divide, GDK_KEY_slash,
  0,
  GDK_KEY_ContextMenu, GDK_KEY_Menu,
  0,
  GDK_KEY_KP_0, GDK_KEY_0,
  0,
  GDK_KEY_KP_1, GDK_KEY_1,
  0,
  GDK_KEY_KP_2, GDK_KEY_2,
  0,
  GDK_KEY_KP_3, GDK_KEY_3,
  0,
  GDK_KEY_KP_4, GDK_KEY_4,
  0,
  GDK_KEY_KP_5, GDK_KEY_5,
  0,
  GDK_KEY_KP_6, GDK_KEY_6,
  0,
  GDK_KEY_KP_7, GDK_KEY_7,
  0,
  GDK_KEY_KP_8, GDK_KEY_8,
  0,
  GDK_KEY_KP_9, GDK_KEY_9,
  0,
};
