...
static void
gdk_broadway_surface_relayout_finished (GdkSurface   *surface,
...
static void
gdk_broadway_surface_queue_relayout (GdkSurface         *surface,
                                     gint                width,
                                     gint                height,
                                     ...
                                     gint                rect_anchor_dy)
{
  gdk_surface_queue_relayout_helper (surface,
                                     ...
                                     rect_anchor_dx,
                                     rect_anchor_dy,
                                     gdk_broadway_surface_relayout_finished);
}

static gboolean
gdk_broadway_surface_finish_relayout (GdkSurface   *surface,
...
gdk_broadway_surface_class_init (GdkBroadwaySurfaceClass *klass)
{
  ...
  impl_class->queue_relayout = gdk_broadway_surface_queue_relayout;
  impl_class->finish_relayout = gdk_broadway_surface_finish_relayout;
