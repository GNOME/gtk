...
gdk_memory_texture_builder_build (GdkMemoryTextureBuilder *self)
{
  ...
  g_return_val_if_fail (self->width % gdk_memory_format_get_block_width (self->format, 0) == 0, NULL);
  g_return_val_if_fail (self->height % gdk_memory_format_get_block_height (self->format, 0) == 0, NULL);
